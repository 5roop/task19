...
def extract_remarks(full_text: str) -> list:
    ...
    import re
    separators = [
        {"Gap_inaudible": r"""([/(][^/()]{0,100}[nN]e razumije[^/()]{0,50}[/)]|[/(][^/()]{0,100}[nN]e čuj[^/()]{0,50}[/)]|[/(].{0,50}[iI]sključen mikrofon[^/()]{0,2}[/)]|[/(][nN]ije uključen mikrofon.{0,1}[/)]|[/(][^/()]{0,30}[gG]ovorni[^/()]{1,4} naknadno uključ[^/()]{0,50}[/)]|[/(][^/()]{0,100}nije snimljen[^/()]{0,3}[/)]|[/(][^/()]{0,100}nema prijevoda[^/()]{0,30}[/)]|[/(][^/()]{0,100}nema preklopa[^/()]{0,30}[/)]|[/(][^/()]{0,50}isključenje[^/()]{0,2}[/)]|[/(][^/()]{0,50}nije izaš[^/()]{0,5} za govornicu[^/()]{0,2}[/)]|[/(][^/()]{0,30}[nN]ismo dobili tekst[^/()]{0,30}[/)]|[/(][^/()]{0,50}nije uključen[^/()]{0,50}[/)]|[/(][^/()]{0,10}[gG]ovori s mjesta[^/()]{0,10}[/)])[\s\.…]*"""},
        ...
        {"Vocal_interruption":r"""[\s\.…]*([/(][[U|u]padic[ae][^/()]{0,200}[/)]|[/(][^/()]{0,30} upozor.{0,10}vrijeme[^/()]{0,50}[/)]|[/(][^/()]{0,50} replik[^/()]{0,50}[/)]|[/(].obacivanje[^/()]{0,100}[/)]|[/(][^/()]{0,30}s[a]{0,1} mjesta[^/()]{0,100}[/)]|[/(][^/()]{0,30}[iI]z klupe[^/()]{0,100}[/)])[\s\.…]*"""},
        {"Vocal_murmur":r"""[\s\.…]*([/(][^)]{0,50}[žŽ]a[mg]or[^/()]{0,50}[/)])[\s\.…]*"""},
        {"Kinesic_applause":r"""[\s\.…]*([/(][^/()]{0,30}plau[^/()]{0,30}[/)]|[/(]APLAUZ[/)]|[/(][^/()]{0,50}[pP]ljesak[^/()]{0,50}[/)])[\s\.…]*"""},
